 ...
 *
 */
public class GDYNValidateLoyaltyIdBeforeSaleSite extends PosSiteActionAdapter {
	...
	public void arrive(BusIfc bus) {
		...
		if (saleCargo.getLoyaltyIdNumber().length() >= 1
			...
			saleCargo.setLoyaltyIdNumber(""); // set empty string if the loyalty is not valid.
			bus.mail(letter, BusIfc.CURRENT);
		}
	}
